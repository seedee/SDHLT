...
static void     Usage()
{
    ...
    Log("    -nofill        : Don't fill outside (masks LEAKs)   (not for final runs)\n");
    ...
    Log("    -texdata #     : Alter maximum texture memory limit  (kb)\n");
    Log("    -lightdata #   : Alter maximum lighting memory limit (kb)\n");
